...
def download_raw_video(url, job_id, tipo="audio"):
    ...
    # Audio: solo audio. Video: formato ya combinado, NUNCA merge (no requiere ffmpeg)
    fmt = "bestaudio/best" if tipo == "audio" else "best[ext=mp4]/best[height<=1080][vcodec!=none][acodec!=none]/best"
    ...
    # Solo agregar merge si ffmpeg está disponible
    if tipo == "video" and ffmpeg_dir:
